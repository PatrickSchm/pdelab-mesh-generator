#ifndef DUNE_PDELAB_ONESTEP_LOCAL_ASSEMBLER_RCOUPLING_HH
#define DUNE_PDELAB_ONESTEP_LOCAL_ASSEMBLER_RCOUPLING_HH

#include <dune/typetree/typetree.hh>

#include <dune/pdelab/residualcoupling/gridoperator/onestep/residualengine_rcoupling.hh>
#include <dune/pdelab/residualcoupling/gridoperator/default/residualengine_coupling_rcoupling.hh>
#include <dune/pdelab/residualcoupling/gridoperator/onestep/patternengine_rcoupling.hh>
#include <dune/pdelab/residualcoupling/gridoperator/onestep/jacobianengine_rcoupling.hh>
#include <dune/pdelab/residualcoupling/gridoperator/onestep/prestageengine_rcoupling.hh>
#include <dune/pdelab/residualcoupling/gridoperator/onestep/jacobianresidualengine_rcoupling.hh>
 ...
 */
template<typename GO, typename GOSL, typename LA0, typename LA1,
         typename LAC0, typename LAC1>
class OneStepLocalAssemblerCoupling: public Dune::PDELab::LocalAssemblerBase <
...
public:
    ...
    typedef LAC0 LocalAssemblerCouplingDT0;
    typedef LAC1 LocalAssemblerCouplingDT1;

    typedef Dune::PDELab::LocalAssemblerTraits<GO> Traits;
    typedef Dune::PDELab::LocalAssemblerTraits<GOSL> TraitsSl;
    ...
    //! @{
    typedef OneStepLocalPatternAssemblerEngineCoupling<OneStepLocalAssemblerCoupling> LocalPatternAssemblerEngine;
    typedef OneStepLocalPreStageAssemblerEngineCoupling<OneStepLocalAssemblerCoupling,
            GOSL> LocalPreStageAssemblerEngine;
    typedef OneStepLocalResidualAssemblerEngineCoupling<OneStepLocalAssemblerCoupling,
            GOSL> LocalResidualAssemblerEngine;
    typedef OneStepLocalJacobianAssemblerEngineCoupling<OneStepLocalAssemblerCoupling, GOSL> LocalJacobianAssemblerEngine;

    typedef typename LA1::LocalPatternAssemblerEngine LocalExplicitPatternAssemblerEngine;
    typedef OneStepExplicitLocalJacobianResidualAssemblerEngineCoupling <
    OneStepLocalAssemblerCoupling > LocalExplicitJacobianResidualAssemblerEngine;

    friend class OneStepLocalPatternAssemblerEngineCoupling <
        OneStepLocalAssemblerCoupling > ;
    friend class OneStepLocalPreStageAssemblerEngineCoupling <
        OneStepLocalAssemblerCoupling, GOSL > ;
    friend class OneStepLocalResidualAssemblerEngineCoupling <
        OneStepLocalAssemblerCoupling, GOSL > ;
    friend class OneStepLocalJacobianAssemblerEngineCoupling <
        OneStepLocalAssemblerCoupling, GOSL > ;
    friend class OneStepExplicitLocalJacobianResidualAssemblerEngineCoupling <
        OneStepLocalAssemblerCoupling > ;
    //! @}
    ...
    OneStepLocalAssemblerCoupling(LA0 & la0_, LA1 & la1_, LAC0 & lac0_, LAC1 & lac1_,
                                  typename Traits::Residual & const_residual_) :
        Base(la0_.trialConstraints(), la0_.testConstraints()), la0(
            la0_), la1(la1_), lac0(lac0_), lac1(lac1_), const_residual(
                const_residual_), time(0.0), dt_mode(
                    MultiplyOperator0ByDT), stage(0), pattern_engine(
                        *this), prestage_engine(*this), residual_engine(
                            *this), jacobian_engine(*this), explicit_jacobian_residual_engine(
                                *this)
    {
        static_checks();
    }
    ...
    void preStep(Real time_, Real dt_, int stages_)
    {
        ...
        lac0.preStep(time_, dt_, stages_);
        lac1.preStep(time_, dt_, stages_);
    }
    ...
    enum DTAssemblingMode
    {
        DivideOperator1ByDT, MultiplyOperator0ByDT, DoNotAssembleDT
    };
    ...
    void setWeight(const Real weight)
    {
        ...
        lac0.setWeight(weight);
        lac1.setWeight(weight);
    }
        ...
        const std::vector<typename Traits::Solution*> & x)
    {
        ...
        explicit_jacobian_residual_engine.setLocalPreStageEngine(
            prestage_engine);
