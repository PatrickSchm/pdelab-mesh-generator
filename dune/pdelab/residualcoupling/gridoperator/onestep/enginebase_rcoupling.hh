#ifndef DUNE_ONE_STEP_ENGINEBASE_RCOUPLING_HH
#define DUNE_ONE_STEP_ENGINEBASE_RCOUPLING_HH
 ...
 */
template<typename OSLA, typename LAE0, typename LAE1, typename LAEC0,
         typename LAEC1>
class OneStepLocalAssemblerEngineBaseCoupling
{
public:
    //! The type of the wrapping local assembler
    typedef OSLA OneStepLocalAssembler;

    typedef typename LAEC0::Traits Traits1;
    typedef typename LAEC1::Traits Traits2;
    ...
    {
        return lae0->needsConstraintsCaching(cu, cv)
               || lae1->needsConstraintsCaching(cu, cv)
               || laec0->needsConstraintsCaching(cu, cv)
               || laec1->needsConstraintsCaching(cu, cv);
    }
    ...
    typedef LAEC0 LocalAssemblerEngineCouplingDT0;
    typedef LAEC1 LocalAssemblerEngineCouplingDT1;
    //! @}
    ...
    /**
     ...
     creates this engine
     */
    OneStepLocalAssemblerEngineBaseCoupling(
        const LocalAssembler & local_assembler_) :
        invalid_lae0(static_cast<LocalAssemblerEngineDT0*>(0)), invalid_lae1(
            static_cast<LocalAssemblerEngineDT1*>(0)), invalid_laec0(
                static_cast<LocalAssemblerEngineCouplingDT0*>(0)), invalid_laec1(
                    static_cast<LocalAssemblerEngineCouplingDT1*>(0)), la(
                        local_assembler_), lae0(invalid_lae0), lae1(
                            invalid_lae1), laec0(invalid_laec0), laec1(
                                invalid_laec1), implicit(true), coupled(true)
    {
    }
    ...
    {
        return implicit
               && (lae0->requireSkeleton() || lae1->requireSkeleton());
    }
    ...
    {
        return laec0->requireCoupling() || laec1->requireCoupling();
    }
    ...
    LocalAssemblerEngineCouplingDT0& localAssemblerEngineCouplingDT0()
    {
        return *laec0;
    }

    const LocalAssemblerEngineCouplingDT0& localAssemblerEngineCouplingDT0() const
    {
        return *laec0;
    }

    LocalAssemblerEngineCouplingDT1& localAssemblerEngineCouplingDT1()
    {
        return *laec1;
    }

    const LocalAssemblerEngineCouplingDT1& localAssemblerEngineCouplingDT1() const
    {
        return *laec1;
    }
    ...
    void setLocalAssemblerEngineCouplingDT0(
        LocalAssemblerEngineCouplingDT0& laec0_)
    {
        laec0 = &laec0_;
    }

    void setLocalAssemblerEngineCouplingDT1(
        LocalAssemblerEngineCouplingDT1& laec1_)
    {
        laec1 = &laec1_;
    }
    ...
    void onBindLFSUV(const EG & eg, const LFSU & lfsu,
                     const LFSV & lfsv)
    {
        lae0->onBindLFSUV(eg, lfsu, lfsv);
        lae1->onBindLFSUV(eg, lfsu, lfsv);
        laec0->onBindLFSUV(eg, lfsu, lfsv);
        laec1->onBindLFSUV(eg, lfsu, lfsv);

    }
    template<typename EG, typename LFSU, typename LFSV>
    void onBindLFSUVOld(const EG & eg, const LFSU & lfsu,
                        const LFSV & lfsv)
    {
        lae0->onBindLFSUVOld(eg, lfsu, lfsv);
    ...
    void onBindLFSUVSL(const EGSL & egSl, const LFSUSL & lfsuSl,
                       const LFSVSL & lfsvSl)
    {
        lae0->onBindLFSUVSL(egSl, lfsuSl, lfsvSl);
        lae1->onBindLFSUVSL(egSl, lfsuSl, lfsvSl);
        laec0->onBindLFSUVSL(egSl, lfsuSl, lfsvSl);
        laec1->onBindLFSUVSL(egSl, lfsuSl, lfsvSl);
    ...
    void onBindLFSV(const EG & eg, const LFSV & lfsv)
    {
        ...
        laec0->onBindLFSV(eg, lfsv);
        laec1->onBindLFSV(eg, lfsv);

    }

    template<typename EGSL, typename LFSVSL>
    void onBindLFSVSL(const EGSL & egSl, const LFSVSL & lfsvSl)
    {

        laec0->onBindLFSVSL(egSl, lfsvSl);
        laec1->onBindLFSVSL(egSl, lfsvSl);
    }
                           ...
                           const LFSV & lfsv)
    {
        ...
        laec0->onBindLFSUVInside(ig, lfsu, lfsv);
        laec1->onBindLFSUVInside(ig, lfsu, lfsv);
    }
                            ...
                            const LFSV_N & lfsv_n)
    {
        ...
        laec0->onBindLFSUVOutside(ig, lfsu_s, lfsv_s, lfsu_n, lfsv_n);
        laec1->onBindLFSUVOutside(ig, lfsu_s, lfsv_s, lfsu_n, lfsv_n);
    ...
    void onBindLFSVInside(const IG & ig, const LFSV & lfsv)
    {
        ...
        laec0->onBindLFSVInside(ig, lfsv);
        laec1->onBindLFSVInside(ig, lfsv);
                           ...
                           const LFSV_N & lfsv_n)
    {
        ...
        laec0->onBindLFSVOutside(ig, lfsv_s, lfsv_n);
        laec1->onBindLFSVOutside(ig, lfsv_s, lfsv_n);
    ...
    void onBindLFSUVCoupling(const IG & ig, const LFSU_S & lfsu_s,
                             ...
                             const LFSV_C & lfsv_c)
    {
        lae0->onBindLFSUVCoupling(ig, lfsu_s, lfsv_s, lfsu_n, lfsv_n,
                                  lfsu_c, lfsv_c);
        lae1->onBindLFSUVCoupling(ig, lfsu_s, lfsv_s, lfsu_n, lfsv_n,
                                  lfsu_c, lfsv_c);
        laec0->onBindLFSUVCoupling(ig, lfsu_s, lfsv_s, lfsu_n, lfsv_n,
                                   lfsu_c, lfsv_c);
        laec1->onBindLFSUVCoupling(ig, lfsu_s, lfsv_s, lfsu_n, lfsv_n,
                                   lfsu_c, lfsv_c);
    }
                            ...
                            const LFSV_N & lfsv_n, const LFSV_C & lfsv_c)
    {
        ...
        laec0->onBindLFSVCoupling(ig, lfsv_s, lfsv_n, lfsv_c);
        laec1->onBindLFSVCoupling(ig, lfsv_s, lfsv_n, lfsv_c);
    }
    ...
    //! @{
    template<typename EG, typename LFSU, typename LFSV>
    void onUnbindLFSUV(const EG & eg, const LFSU & lfsu,
                       const LFSV & lfsv)
    {
        lae0->onUnbindLFSUV(eg, lfsu, lfsv);
        lae1->onUnbindLFSUV(eg, lfsu, lfsv);
        laec0->onUnbindLFSUV(eg, lfsu, lfsv);
        laec1->onUnbindLFSUV(eg, lfsu, lfsv);
    }
    ...
    void onUnbindLFSV(const EG & eg, const LFSV & lfsv)
    {
        ...
        laec0->onUnbindLFSV(eg, lfsv);
        laec1->onUnbindLFSV(eg, lfsv);
    }
    ...
    void onUnbindLFSUVC(const EGSL & egSl, const LFSUSL & lfsuSl,
                        const LFSVSL & lfsvSl)
    {
        laec0->onUnbindLFSUVC(egSl, lfsuSl, lfsvSl);
        laec1->onUnbindLFSUVC(egSl, lfsuSl, lfsvSl);
    }

    template<typename EGSL, typename LFSVSL>
    void onUnbindLFSVC(const EGSL & egSl, const LFSVSL & lfsvSl)
    {

        laec0->onUnbindLFSVC(egSl, lfsvSl);
        laec1->onUnbindLFSVC(egSl, lfsvSl);
    }
                             ...
                             const LFSV & lfsv)
    {
        ...
        laec0->onUnbindLFSUVInside(ig, lfsu, lfsv);
        laec1->onUnbindLFSUVInside(ig, lfsu, lfsv);
    }
    ...
    void onUnbindLFSVInside(const IG & ig, const LFSV & lfsv)
    {
        ...
        laec0->onUnbindLFSVInside(ig, lfsv);
        laec1->onUnbindLFSVInside(ig, lfsv);
    }
                               ...
                               const LFSV_C & lfsv_c)
    {
        ...
        lae0->onUnbindLFSUVCoupling(ig, lfsu_s, lfsv_s, lfsu_n, lfsv_n,
                                    lfsu_c, lfsv_c);
        lae1->onUnbindLFSUVCoupling(ig, lfsu_s, lfsv_s, lfsu_n, lfsv_n,
                                    lfsu_c, lfsv_c);
    ...
    void loadCoefficientsLFSUInside(const LFSU & lfsu_s)
    {
        ...
        laec0->loadCoefficientsLFSUInside(lfsu_s);
        laec1->loadCoefficientsLFSUInside(lfsu_s);
    }
    template<typename LFSU>
    void loadCoefficientsLFSUInsideOld(const LFSU & lfsu_s)
    {
        lae0->loadCoefficientsLFSUInsideOld(lfsu_s);
        lae1->loadCoefficientsLFSUInsideOld(lfsu_s);
    ...
    {
        laec0->loadCoefficientsLFSUInsideSl(lfsu_sSl);
        laec1->loadCoefficientsLFSUInsideSl(lfsu_sSl);
    }
    ...
    bool assembleCell(const EG & eg)
    {
        ...
        rv &= laec0->assembleCell(eg);
        rv &= laec1->assembleCell(eg);
        return rv;
    }
    ...
    void assembleCBoundaryReversed(const EG& eg, const IGC& igC, const LFSU& lfsu,
        ...
        if (implicit)
            laec0->assembleCBoundaryReversed(eg, igC, lfsu, lfsv,
                                             lfsuC, lfsvC, fractureHeight);
        laec1->assembleCBoundaryReversed(eg, igC, lfsu, lfsv, lfsuC,
                                         lfsvC, fractureHeight);
    }
    ...
    {
        if (implicit)
            lae0->assembleUVEnrichedCoupling(ig, lfsu_s, lfsv_s, lfsu_n,
                                             lfsv_n, lfsu_c, lfsv_c);
        lae1->assembleUVEnrichedCoupling(ig, lfsu_s, lfsv_s, lfsu_n,
                                         lfsv_n, lfsu_c, lfsv_c);
    }
...
private:
    ...
    LocalAssemblerEngineCouplingDT0 * const invalid_laec0;
    LocalAssemblerEngineCouplingDT1 * const invalid_laec1;
...
//! constructed this engine
    ...
    LocalAssemblerEngineCouplingDT0 * laec0;
    LocalAssemblerEngineCouplingDT1 * laec1;

    bool implicit;
    bool coupled;

};
// End of class OneStepLocalAssemblerEngineBaseCoupling
