#ifndef DUNE_PDELAB_DEFAULT_LOCAL_ASSEMBLER_NORMAL_RCOUPLING_HH
#define DUNE_PDELAB_DEFAULT_LOCAL_ASSEMBLER_NORMAL_RCOUPLING_HH
...
#include <dune/pdelab/residualcoupling/gridoperator/default/jacobianengine_normal_rcoupling.hh>
...
class DefaultLocalAssemblerNormalRCoupling: public Dune::PDELab::LocalAssemblerBase <
...
public:
    ...
    DefaultLocalAssemblerNormalRCoupling > LocalPatternAssemblerEngine;
    typedef DefaultLocalResidualAssemblerEngineNormalRCoupling <
    DefaultLocalAssemblerNormalRCoupling > LocalResidualAssemblerEngine;
    typedef DefaultLocalJacobianAssemblerEngineNormalRCoupling <
    DefaultLocalAssemblerNormalRCoupling > LocalJacobianAssemblerEngine;
    typedef DefaultLocalJacobianApplyAssemblerEngineRCoupling <
    DefaultLocalAssemblerNormalRCoupling > LocalJacobianApplyAssemblerEngine;

    friend class DefaultLocalPatternAssemblerEngineNormalRCoupling <
        DefaultLocalAssemblerNormalRCoupling > ;
    friend class DefaultLocalResidualAssemblerEngineNormalRCoupling <
        DefaultLocalAssemblerNormalRCoupling > ;
    friend class DefaultLocalJacobianAssemblerEngineNormalRCoupling <
        DefaultLocalAssemblerNormalRCoupling > ;
    ...
    DefaultLocalAssemblerNormalRCoupling(LOP & lop_,
    ...
    DefaultLocalAssemblerNormalRCoupling(LOP & lop_, const CU& cu_,
                                         const CV& cv_,
                                         shared_ptr<typename GO::BorderDOFExchanger> border_dof_exchanger) :
        ...
        const typename Traits::Solution & x)
    {
        ...
        // Dune::printvector(std::cout, x, "Solution ", "Position ");
