#ifndef DUNE_PDELAB_DEFAULT_APPLYJACOBIANENGINE_RCOUPLING_HH
#define DUNE_PDELAB_DEFAULT_APPLYJACOBIANENGINE_RCOUPLING_HH
...
class DefaultLocalJacobianApplyAssemblerEngineRCoupling
...
public:
  ...
  /**
     ...
     creates this engine
  */
  DefaultLocalJacobianApplyAssemblerEngineRCoupling(const LocalAssembler & local_assembler_)
  ...
  void assembleUVVolumePostSkeleton(const EG & eg, const LFSUC & lfsu_cache, const LFSVC & lfsv_cache)
  {
    ...
    void assembleCBoundary(const IG& ig, const EGC& egC, const LFSUC& lfsu_cache,
                           ...
                           const LFSVCC& lfsvC_cache)
    {
        ...
        Dune::PDELab::LocalAssemblerCallSwitchRCoupling<LOP,
             LOP::doBoundaryCoupling>::jacobian_apply_coupling(lop, ig, egC,
                                                         lfsu_cache.localFunctionSpace(), xl,
                                                         lfsv_cache.localFunctionSpace(), rl_view);
    }

    template<typename EG, typename IGC, typename LFSUC, typename LFSVC, typename LFSUCC, typename LFSVCC>
                                   ...
                                   const LFSVCC& lfsvC_cache)
    {
        ...
        Dune::PDELab::LocalAssemblerCallSwitchRCoupling<LOP,
             LOP::doBoundaryCouplingReversed>::jacobian_apply_coupling_reversed(lop, eg, igC,
                                                                          lfsu_cache.localFunctionSpace(), xl,
