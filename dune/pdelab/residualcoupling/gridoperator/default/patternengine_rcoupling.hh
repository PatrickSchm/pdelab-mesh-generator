#ifndef DUNE_PDELAB_DEFAULT_PATTERNENGINE_RCOUPLING_HH
#define DUNE_PDELAB_DEFAULT_PATTERNENGINE_RCOUPLING_HH
...
class DefaultLocalPatternAssemblerEngineRCoupling: public LocalAssemblerEngineBaseRCoupling
{
public:
    ...
    /**
     ...
     creates this engine
     */
    DefaultLocalPatternAssemblerEngineRCoupling(
