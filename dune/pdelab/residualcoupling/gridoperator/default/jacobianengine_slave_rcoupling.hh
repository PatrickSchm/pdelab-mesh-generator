#ifndef DUNE_PDELAB_DEFAULT_JACOBIANENGINE_SLAVE_HH
#define DUNE_PDELAB_DEFAULT_JACOBIANENGINE_SLAVE_HH
...
class DefaultLocalJacobianAssemblerEngineSlave: public LocalAssemblerEngineBaseRCoupling
{
public:
    ...
    typedef typename LA::Traits::JacobianSl Jacobian;
    ...
    typedef typename LA::Traits::SolutionSl Solution;
    ...
    /**
     ...
     creates this engine
     */
    DefaultLocalJacobianAssemblerEngineSlave(
    ...
    const typename LocalAssembler::Traits::TrialGridFunctionSpaceConstraintsSl& trialConstraints() const
    {
        return localAssembler().trialConstraints();
    }

    //! Test space constraints
    const typename LocalAssembler::Traits::TestGridFunctionSpaceConstraintsSl& testConstraints() const
    {
