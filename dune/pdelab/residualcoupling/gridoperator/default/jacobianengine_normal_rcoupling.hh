#ifndef DUNE_PDELAB_DEFAULT_JACOBIANENGINE_NORMAL_RCOUPLING_HH
#define DUNE_PDELAB_DEFAULT_JACOBIANENGINE_NORMAL_RCOUPLING_HH
...
class DefaultLocalJacobianAssemblerEngineNormalRCoupling: public LocalAssemblerEngineBaseRCoupling
{
public:
    ...
    /**
     ...
     creates this engine
     */
    DefaultLocalJacobianAssemblerEngineNormalRCoupling(
