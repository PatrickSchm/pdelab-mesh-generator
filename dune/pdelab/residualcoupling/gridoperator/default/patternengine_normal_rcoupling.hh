#ifndef DUNE_PDELAB_DEFAULT_PATTERNENGINE_NORMAL_RCOUPLING_HH
#define DUNE_PDELAB_DEFAULT_PATTERNENGINE_NORMAL_RCOUPLING_HH
...
class DefaultLocalPatternAssemblerEngineNormalRCoupling
...
public:
    ...
    /**
     ...
     creates this engine
    */
    DefaultLocalPatternAssemblerEngineNormalRCoupling(const LocalAssembler & local_assembler_,
    ...
    // {
    //     Dune::PDELab::LocalAssemblerCallSwitchRCoupling<LOP, LOP::doPatternCoupling>::
    //     pattern_coupling(lop, lfsv_cache.localFunctionSpace(), lfsuC_cache.localFunctionSpace(), lfsvC_cache.localFunctionSpace(), localpattern_coupling);
    // }

    template<typename IG, typename EGC, typename LFSUC, typename LFSVC, typename LFSUCC, typename LFSVCC, typename FH>
    ...
    {
        Dune::PDELab::LocalAssemblerCallSwitchRCoupling<LOP, LOP::doPatternCoupling>::
        pattern_coupling(lop, lfsu_cache.localFunctionSpace(), lfsv_cache.localFunctionSpace(), lfsuC_cache.localFunctionSpace(), lfsvC_cache.localFunctionSpace(), localpattern_coupling);
    }
...
private:
    ...
    LocalPattern localpattern_sn, localpattern_ns, localpattern_coupling;
