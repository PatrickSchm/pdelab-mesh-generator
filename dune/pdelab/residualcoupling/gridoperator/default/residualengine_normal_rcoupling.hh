#ifndef DUNE_PDELAB_DEFAULT_RESIDUALENGINE_NORMAL_RCOUPLING_HH
#define DUNE_PDELAB_DEFAULT_RESIDUALENGINE_NORMAL_RCOUPLING_HH
...
class DefaultLocalResidualAssemblerEngineNormalRCoupling: public LocalAssemblerEngineBaseRCoupling
{
public:
    ...
    /**
     ...
     creates this engine
     */
    DefaultLocalResidualAssemblerEngineNormalRCoupling(
                          ...
                          const LFSVC & lfsv_cache, int iMat)
    {
        ...
        Dune::PDELab::LocalAssemblerCallSwitchRCoupling<LOP,
             LOP::doAlphaVolume>::alpha_volume(lop, eg,
