#ifndef DUNE_PDELAB_GRIDOPERATOR_NORMAL_RCOUPLING_HH
#define DUNE_PDELAB_GRIDOPERATOR_NORMAL_RCOUPLING_HH
...
#include <dune/pdelab/residualcoupling/gridoperator/default/assembler_normal_rcoupling.hh>
#include <dune/pdelab/residualcoupling/gridoperator/default/localassembler_normal_rcoupling.hh>
...
namespace Dune
{
    namespace PDELab
    {
         ...
         */
        template<typename GFSU, typename GFSV, typename LOP, typename MB,
        ...
        class GridOperatorNormalRCoupling: public impl::warn_on_deprecated_nonoverlapping_mode_parameter<
                nonoverlapping_mode>
        {
        public:
            ...
            typedef DefaultAssemblerNormalRcoupling<GFSU, GFSV, CU, CV,
                    static_cast<bool>(nonoverlapping_mode)> Assembler;
            ...
            typedef DefaultLocalAssemblerNormalRCoupling<
                    GridOperatorNormalRCoupling, LOP,
                    GFSU::Traits::EntitySet::Partitions::partitionIterator()
            ...
            typedef typename conditional<
                    ...
                    NonOverlappingBorderDOFExchanger<GridOperatorNormalRCoupling>,
                    OverlappingBorderDOFExchanger<GridOperatorNormalRCoupling> >::type BorderDOFExchanger;

            //! The grid operator traits
            typedef Dune::PDELab::GridOperatorTraits<GFSU, GFSV, MB, DF, RF, JF,
                    CU, CV, Assembler, LocalAssembler> Traits;
            ...
            GridOperatorNormalRCoupling(const GFSU & gfsu_, const CU & cu_, const GFSV & gfsv_, const CV & cv_, LOP & lop_, const MB& mb_ = MB())
            ...
            GridOperatorNormalRCoupling(const GFSU & gfsu_, const GFSV & gfsv_, LOP & lop_, const MB& mb_ = MB())
            ...
            void jacobian_apply(const Domain & x, Range & r) const
            {
                ...
                JacobianApplyEngine & jacobian_apply_engine =
                        local_assembler.localJacobianApplyAssemblerEngine(r, x);
