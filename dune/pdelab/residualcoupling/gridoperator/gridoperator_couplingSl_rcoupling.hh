#ifndef DUNE_PDELAB_GRIDOPERATOR_COUPLINGSL_RCOUPLING_HH
#define DUNE_PDELAB_GRIDOPERATOR_COUPLINGSL_RCOUPLING_HH
...
#include <dune/pdelab/residualcoupling/gridoperator/default/assemblerSl_rcoupling.hh>
...
template < typename GFSUMA, typename GFSVMA, typename GFSUSL,
           typename GFSVSL, typename FP,
           typename MaterialFlags, typename InPara, typename LOP, typename LOPSL, typename MB,
...
class GridOperatorCouplingSl: public impl::warn_on_deprecated_nonoverlapping_mode_parameter <
    nonoverlapping_mode >
{
public:
    ...
    typedef DefaultAssemblerCouplingSl<GFSUMA, GFSVMA, GFSUSL, GFSVSL, CU,
    ...
    typedef DefaultLocalAssemblerSlave<GridOperatorCouplingSl, LOPSL,
            GFSUSL::Traits::EntitySet::Partitions::partitionIterator()
            == InteriorBorder_Partition> LocalAssemblerSlave;

    typedef DefaultLocalAssemblerCoupling<GridOperatorCouplingSl,
    ...
    NonOverlappingBorderDOFExchanger<GridOperatorCouplingSl>,
    OverlappingBorderDOFExchanger<GridOperatorCouplingSl> >::type BorderDOFExchanger;

    typedef typename std::conditional <
    GFSUSL::Traits::EntitySet::Partitions::partitionIterator()
    == InteriorBorder_Partition,
    NonOverlappingBorderDOFExchanger<GridOperatorCouplingSl>,
    OverlappingBorderDOFExchanger<GridOperatorCouplingSl> >::type BorderDOFExchangerSl;
    ...
    GridOperatorCouplingSl(const GFSUMA & gfsuMa_, const GFSUSL & gfsuSl_,
                         ...
                         const MB& mb_ = MB()) :
        global_assembler(gfsuMa_, gfsvMa_, gfsuSl_, gfsvSl_,fracturePairs_,
    ...
    GridOperatorCouplingSl(const GFSUMA & gfsuMa_, const GFSVMA & gfsvMa_,
...
//! each tuple element.
    ...
    //! Assembler jacobian
    void jacobian(const Domain & x, const DomainSl & xSl, Jacobian & a) const
    {
        typedef typename LocalAssembler::LocalJacobianAssemblerEngine JacobianEngine;
        JacobianEngine & jacobian_engine =
            local_assembler.localJacobianAssemblerEngine(a, x, xSl);
